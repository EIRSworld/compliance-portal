<table>
    ...
    @foreach($events_regulars_operations as $events_regulars_operation)
        <tr>
            <td> {{  $events_regulars_operation->country->name }}</td>
            <td> {{  $events_regulars_operation->entity->entity_name }}</td>
            <td>{{ $events_regulars_operation->event_name }}</td>
            <td>{{ \Carbon\Carbon::parse($events_regulars_operation->due_date)->format('Y-m-d') }}</td>

            <td>{{ $events_regulars_operation->status }}</td>
