...
return new class extends Migration
{
    ...
    {
        Schema::create('compliance_secondary_sub_menus', function (Blueprint $table) {
            $table->id();
            $table->foreignId('document_id')->nullable();
            $table->foreignId('compliance_menu_id')->nullable();
            $table->foreignId('compliance_sub_menu_id')->nullable();
            $table->foreignId('compliance_primary_sub_menu_id')->nullable();
    ...
    {
        Schema::dropIfExists('compliance_secondary_sub_menus');
    }
};
