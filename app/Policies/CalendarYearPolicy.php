...
class CalendarYearPolicy
{
    ...
    {
        return $user->can('view_any_calendar::year');
    }
    ...
    {
        return $user->can('view_calendar::year');
    }
    ...
    {
        return $user->can('create_calendar::year');
    }
    ...
    {
        return $user->can('update_calendar::year');
    }
    ...
    {
        return $user->can('delete_calendar::year');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, CalendarYear $calendarYear): bool
    {
